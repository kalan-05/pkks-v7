...
<head>
  ...
  <link rel="stylesheet" href="css/2_about.css?v=041a-r2">
  ...
  <link rel="stylesheet" href="css/6_details.css?v=040a">
  ...
  <script defer src="vendor/gsap/gsap.min.js?v=3.15.0"></script>
  <script defer src="vendor/gsap/ScrollTrigger.min.js?v=3.15.0"></script>
  <script defer src="vendor/gsap/ScrollSmoother.min.js?v=3.15.0"></script>
  <script defer src="js/gsap-scroll-smoother.js?v=036e"></script>
  <script defer src="js/header.js?v=036a"></script>
  <script defer src="js/requisites-actions.js?v=040a-r9"></script>
</head>
      ...
      <section class="section-six-details container">
        ...
        <div class="section-six-details__content">
          <dl class="details-list">
            <div class="details-list__group" data-requisites-card>
              <dd data-requisites-field="company"><strong>Фирменное наименование:</strong>&nbsp;ООО «Правовая контора К.&nbsp;Сопрачева»</dd>
              <dd data-requisites-field="address"><strong>Адрес:</strong>&nbsp;197374, г.&nbsp;Санкт-Петербург, ул.&nbsp;Савушкина, д.&nbsp;115,
                к.&nbsp;1, пом.&nbsp;24Н, лит.&nbsp;А</dd>
              <dt></dt>
              <dd data-requisites-field="phone"><strong>Телефон:</strong>&nbsp;
                <a class="details-list__link" href="tel:+78124302884">+7&nbsp;(812)&nbsp;430-28-84
                </a>
                (многоканальный)
              </dd>
              <dd data-requisites-field="email"><strong>E-mail:</strong>&nbsp;
                <a class="details-list__link" href="mailto:soprachev@pkks.spb.ru">soprachev@pkks.spb.ru
                </a>
              </dd>
              <dd data-requisites-field="registration"><strong>ОГРН</strong>&nbsp;1027800518888&nbsp;<strong>ИНН</strong>&nbsp;7801106330&nbsp;</dd>
              <dd data-requisites-field="statistics"><strong>КПП</strong>&nbsp;781401001&nbsp;<strong>ОКПО</strong>&nbsp;35531946</dd>
              <dd data-requisites-field="bank">р/с 40702810455000007540 в Северо-Западном банке ПАО «СБЕРБАНК», г.&nbsp;Санкт-Петербург,&nbsp;к/с
                30101810500000000653, БИК 044030653</dd>
              <dd data-requisites-field="director"><strong>Генеральный директор:</strong>&nbsp;Сопрачев Константин Александрович</dd>
              <dd data-requisites-field="taxation"><strong>Система налогообложения:</strong>&nbsp;ООО «Правовая контора К.Сопрачева» является субъектом
              ...
              <!-- Действия используют только видимые реквизиты этой карточки. -->
              <div class="details-list__actions" data-requisites-actions hidden>
                <button class="details-list__action details-list__action--primary" type="button" data-requisites-copy>
                  Скопировать реквизиты
                </button>
                <button class="details-list__action" type="button" data-requisites-download>
                  Скачать реквизиты
                </button>
              </div>
              <p class="details-list__status" data-requisites-status role="status" aria-live="polite"></p>
            </div>
          </dl>
        </div>
      </section>
        ...
        <div class="contacts-payment">
          <div class="contacts-payment__container container">
            ...
            <a class="contacts-payment__button"
              href="https://qr.nspk.ru/AS1A00225485N3RE9F09MT56LOUDLAUF?type=01&bank=100000000111&crc=B0D5"
            ...
            <div class="contact-row">
              <div class="contact-column">
                <div class="contacts-content">
                  <a class="address" href="https://dev.polymap.ru/pkks" target="_blank" rel="noopener noreferrer" aria-label="Открыть схему проезда к офису Правовой конторы К. Сопрачева в PolyMap">АДРЕС</a>
                  <ul class="contacts-list">
                    <li>197374, г.&nbsp;Санкт-Петербург, ул.&nbsp;Савушкина, д.&nbsp;115, к.&nbsp;1, пом.&nbsp;24Н <a class="phone" href="https://dev.polymap.ru/pkks" target="_blank" rel="noopener noreferrer" aria-label="Открыть схему проезда к офису Правовой конторы К. Сопрачева в PolyMap">(схема проезда)</a></li>
                    <li>
              ...
              <div class="imgEntrance">
                <a class="imgEntrance__link"
                  href="https://dev.polymap.ru/pkks"
                  target="_blank" rel="noopener noreferrer"
                  aria-label="Открыть схему проезда к офису Правовой конторы К. Сопрачева в PolyMap"><img src="img/offic.webp" title="Офис ООО “Правовая контора К. Сопрачева”"
